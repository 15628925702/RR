...
ap = argparse.ArgumentParser(); ap.add_argument('--budget',type=int,required=True); ap.add_argument('--rep',type=int,required=True); ap.add_argument('--h-tilted',type=int,required=True); ap.add_argument('--h-cond',type=int,required=True); ap.add_argument('--qmc-order',type=int,default=8); ap.add_argument('--oracle-h',action='store_true'); ap.add_argument('--out',required=True); args=ap.parse_args()
try:
